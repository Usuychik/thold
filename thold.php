	...
	if (read_config_option("thold_disable_legacy") != 'on') {
		$extra = array(
			...
			'alert_phones_extra' => array(
				...
				'textarea_rows' => 3,
				'textarea_cols' => 50,
				'description' => 'You may specify here extra Phones to receive alerts for this data source (comma separated)',
				'value' => isset($thold_item_data['alert_phones_extra']) ? $thold_item_data['alert_phones_extra'] : ''
			),
			'warning_phones_extra' => array(
				...
				'textarea_rows' => 3,
				'textarea_cols' => 50,
				'description' => 'You may specify here extra Phones to receive warnings for this data source (comma separated)',
				'value' => isset($thold_item_data['warning_phones_extra']) ? $thold_item_data['warning_phones_extra'] : ''
			),
			'alert_command' => array(
...
<script type="text/javascript">
	function Template_EnableDisable() {
		...
		_f.alert_phones_extra.disabled = status;
		_f.warning_phones_extra.disabled = status;
